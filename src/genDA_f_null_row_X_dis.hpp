// --- genDA_f_null_row_X_dis.hpp ---

// genDA_f_null_row_X_dis is the genDA algorithm used to fit GLLVMs when there are no covariates, row effects, or dispersion parameters to be fit.
#undef TMB_OBJECTIVE_PTR
#define TMB_OBJECTIVE_PTR obj
template <class Type>
Type genDA_f_null_row_X_dis(objective_function<Type>* obj) {
